...
// Skills
export const consideredDate = "2009-12-01";
export const cupOfCoffeeADay = 1;
export const workingHoursPerDay = 8;
export const projectsPerClient = 2;
export const clients = 11;